...
if opcao == "A":
	tipo_crip = input("Digite o tipo de Criptografia que será utilzada:\nA = AES;\nB = DES;\n").capitalize()
	...
	tipo_decrip = input("Digite o tipo de Descriptografia que será utilzada:\nA = AES;\nB = DES;\n").capitalize()
	print("Digite o tipo de arquivo que deseja descriptografar:")
	tipo_arq = input("A = Texto;\nB = Arquivo;\nC = imagem;\n").capitalize()
	
	if tipo_arq == "A":
		key = b'\xbf\xc0\x85)\x10nc\x94\x02)j\xdf\xcb\xc4\x94\x9d(\x9e[EX\xc8\xd5\xbfI{\xa2$\x05(\xd5\x18'
		message = input("Digite a mensagem que será descriptografada: ")
		cipher = AES.new(key)
